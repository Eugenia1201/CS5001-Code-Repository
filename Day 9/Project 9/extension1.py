"""CS 5001 - Kaiqi Zhang - Project 9 'Into the Forest' Extension 1 - 18 Nov
"""
...
class ForestConfig:
    ...
    def __init__(self, nkids_min, nkids_max, kid_size_min, kid_size_max,
                 tree_size_min, tree_size_max, nflyer_min, nflyer_max,
                 flyer_size_min, flyer_size_max):
