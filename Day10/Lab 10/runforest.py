"""CS5001 - Lab10 - The file to run the forest drawing"""
...
class App:
    ...
    def run(self):
        ...
        with open("forestconfig.json", "r", newline="") as in_file:
            ...
            # forestconfig_de.config = config_de.__dict__
        forest = Forest()
...
class Family:
    ...
    def __init__(self, animal_class):
        ...
        self.kids = []
        num_kids = random.randint(config_de.nkids_min, config_de.nkids_max)
        for x in range(num_kids):
            kid = animal_class(800, 800, size=random.uniform(
                config_de.kid_size_min, config_de.kid_size_max))
...
class Forest:
    ...
    def __init__(self):
        ...
        num_trees = random.randint(config_de.ntrees_min, config_de.ntrees_max)
        for _ in range(num_trees):
            tree = Tree(x=random.randint(10, window.width-200),
                        y=random.randint(200, window.height-250),
                        size=random.uniform(config_de.tree_size_min,
                                            config_de.tree_size_max))
...
class Flock:
    ...
    def __init__(self, animal_class, forest):
        ...
        for _ in range(random.randint(config_de.nflyer_min,
                                      config_de.nflyer_max)):
            ...
            flyer = animal_class(x, y, size=random.uniform(
                config_de.flyer_size_min, config_de.flyer_size_max))
