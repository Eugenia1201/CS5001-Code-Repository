...
# Set up the window
window = pyglet.window.Window(1000, 800, "Into the Sea World")
the_seaworld = None
submarine = None
...
class SeaObjects:
    """This is an interface for FishFamily, SeastarFamily, SeagrassCluster and
    Submarine classes to show the methods they have in common"""
    def move(self):
        pass
...
class FishFamily(SeaObjects):
    def __init__(self, x, y, animal_class):
        ...
        self.fish_list = []
        for _ in range(3, 10):  # later config
    ...
    def move(self):
        ...
        for fish in self.fish_list:
            fish.move(self.x + random.randrange(10, 100),
                      self.y + random.randrange(10, 100))
...
class SeastarFamily(SeaObjects):
    def __init__(self, x, y, animal_class):
        ...
        self.y = y
        self.seastar_list = []
        for _ in range(2, 5):  # later config
...
class SeagrassCluster(SeaObjects):
    ...
    def rest_x(self):
        return random.randrange(self.x-20, self.x+20)

    def rest_y(self):
        return random.randrange(self.y-20, self.y+20)
...
class SeaAnimal:
    ...
    def draw(self):
        """Draw the SeaLife using Pyglet graphics"""
        self.batch.draw()
...
class Seastar(SeaAnimal):
    """Represent a Seastar, a subclass of the SeaLife class"""
